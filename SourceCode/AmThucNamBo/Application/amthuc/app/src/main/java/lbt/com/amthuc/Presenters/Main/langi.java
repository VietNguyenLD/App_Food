...
public class langi {
    public String TAG = "langi";

    iangi mInterface;
    FirebaseDatabase mDatabase;

    public langi(iangi mInterface) {
    ...
    public void getDacSan(String makhuvuc){
        Log.e("kiemtra", makhuvuc);
        DatabaseReference mRef = mDatabase.getReference().child("dacsans").child("KVMN").child(makhuvuc).child("monans");
        mRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue()!=null){
                    Log.i("kiemtra", dataSnapshot.getValue().toString());
                    ...
                    mInterface.danhsachbaivietphobien_AnGi(null);
                    mInterface.danhsachbaivietdacsan_AnGi(null);
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue()!=null){
                    ...
                    if(mthongke.size()!=0) {
                        ...
                        mInterface.danhsachbaivietphobien_AnGi(mlist);
                    }else {
                        ArrayList<objbaiviet_app> mlist = new ArrayList<>();
                        int sl = 0;
                        for (objbaiviet_app j : baiviet) {
                ...
                //show all bài viết
                mInterface.danhsachbaivietdacsan_AnGi(baiviet);
            }
